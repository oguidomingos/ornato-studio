...
export default function Footer() {
  return (
    <footer className="bg-footer-bg border-t border-white/5 pt-16 sm:pt-20 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Instagram Hanna Almeida"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-gold/30 hover:text-gold transition-all duration-300 text-white/30"
                aria-label="WhatsApp Hanna Almeida"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/15 text-xs">
            &copy; {new Date().getFullYear()} Hanna Almeida. Todos os direitos reservados.
          </p>
