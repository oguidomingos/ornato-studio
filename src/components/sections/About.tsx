        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
              <p>
                Sou a Hanna, tatuadora em Brasília há 8 anos, e o que mais me fascina na
                tatuagem é a oportunidade de transformar a sua ideia em uma arte que vai te
                acompanhar para sempre. Ao longo dessa jornada, me aprofundei no{' '}
                <em>Ornamental, Fine Line</em> e <em>Realismo</em>, estilos que exigem
                precisão, técnica e muita sensibilidade.
              </p>
              <p>
                Quando você senta na minha maca, meu objetivo é garantir que a arte flua
                perfeitamente com o seu corpo e faça sentido com a sua história. Quero que o
                seu processo seja tranquilo, no seu tempo, sem pressa. Meu espaço foi pensado
                para que você se sinta em casa, com segurança, limpeza impecável e todo o
                suporte necessário antes, durante e depois da sessão. Vamos criar algo único
                juntos?
              </p>
            </div>
